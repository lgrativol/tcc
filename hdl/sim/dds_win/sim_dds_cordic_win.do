...
add wave sim:/dds_cordic_win_tb/UUT/dds_cordic_valid_i 
...
add wave -divider
add wave sim:/dds_cordic_win_tb/UUT/dds_cordic_valid_o 
add wave -radix sfixed sim:/dds_cordic_win_tb/UUT/dds_cordic_sine_phase
add wave -divider Window
add wave sim:/dds_cordic_win_tb/UUT/win_valid_i 
...
add wave -divider
add wave sim:/dds_cordic_win_tb/UUT/win_valid_o 
...
add wave sim:/dds_cordic_win_tb/UUT/dds_generic_shift_valid_i 
add wave sim:/dds_cordic_win_tb/UUT/dds_generic_shift_input_data 
add wave -divider
add wave sim:/dds_cordic_win_tb/UUT/dds_generic_shift_valid_o 
...
add wave sim:/dds_cordic_win_tb/UUT/win_generic_shift_valid_i 
add wave sim:/dds_cordic_win_tb/UUT/win_generic_shift_input_data 
add wave -divider
add wave sim:/dds_cordic_win_tb/UUT/win_generic_shift_valid_o 
add wave sim:/dds_cordic_win_tb/UUT/win_generic_shift_output_data
add wave -divider Result
add wave sim:/dds_cordic_win_tb/UUT/stage_4_valid_i 
...
add wave -divider
add wave sim:/dds_cordic_win_tb/UUT/stage_4_valid_reg 
